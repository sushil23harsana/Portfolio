...
const projects = [
  ...
  { index: "03", accent: "blue", title: "BitTorrent Client", blurb: "A peer-to-peer file-sharing client built from scratch in Go — bencode parser, tracker protocol and concurrent, piece-based downloads with SHA-1 integrity checks.", tags: ["Go", "P2P", "Concurrency"], links: [{ label: "GitHub", href: GH }] },
  { index: "04", accent: "magenta", title: "Personal Finance Manager", blurb: "Backend for a finance-insight system using GenAI-assisted retrieval — LLM-backed summarization and insight generation over user data, built on FastAPI.", tags: ["Python", "FastAPI", "RAG"], links: [{ label: "GitHub", href: GH }] },
];
